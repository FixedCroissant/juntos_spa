     ...
     <div v-if="$can('read', 'Admin')">
       <v-row>
        ...
        <v-row>
                ...
                <v-col cols="12" md="4" sm="5">
                    <!-- <template v-for="roles,i in userRole">
                                        {{i}} {{roles.checked}}
                                    <v-switch
                    ...
                    <!--Other Available Roles to Pick-->
                    <!-- <template v-for="roles,i in availableRoles">
                        <!-- {{userRole[i]}} -->
                            <!-- <v-switch
                            v-model="roles.checked"
                            :label="roles.name"
                    ...
                    <!--USING MAINCOLLECTION FROM SERVER-->
        ...
        <v-row>
             <v-col cols="12" md="2" sm="2"  offset-md="1">
                        <v-btn class="primary" v-on:click="updateRoleInformation">Update Information</v-btn>
                </v-col>
                <v-col cols="12" md="4" sm="5">
                        &nbsp;
                </v-col>

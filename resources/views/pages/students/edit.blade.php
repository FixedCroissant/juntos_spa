                            ...
                            <div class="col-md-5 offset-1">
                                        ...
                                        <label for="county" class="col-form-label">County</label>
                                         <select class="form-control" name="county">
                                             @foreach($countyOptions as $countyOptionsAvailable)
                                                 <option value="{{$countyOptionsAvailable->county_name}}" {{$countyOptionsAvailable->county_name == $student->county ?'selected':''}}>{{$countyOptionsAvailable->county_name}}</option>
                                             @endforeach
                                         </select>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        {!! Form::select('ethnicity', ['Latino'=>'Latino','White'=>"White",'Black or African American'=>"Black or African American",'American Indian'=>'American Indian','Asian'=>'Asian','Native Hawaiian or Other Pacific Islander'=>'Native Hawaiian or Other Pacific Islander','Other'=>'Other'], null, ['class'=>'form-control','placeholder' => 'Pick a selection...']); !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">

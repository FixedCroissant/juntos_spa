                        ...
                        <div class="col-md-3 col-lg-3 offset-8">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Parent Reporting</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card report-adjustment-card">
                            ...
                            <div class="row">
                                <div class="col-md-11 offset-1">
                                    <p>
                                        The filters provided below are based on the associated student. <br/>
                                        For example, if you have students that are in Pender county, this will list the parents associated with that student filtered by that county.
                                        <br/>
                                        <br/>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {!! Form::open(['route' => 'reporting.parents.download', 'method' => 'get']) !!}

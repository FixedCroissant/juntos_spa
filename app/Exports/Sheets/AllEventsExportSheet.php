...
class AllEventsExportSheet implements FromView, WithTitle, ShouldAutoSize,WithEvents
{
    public $site;
    public $event_type;
    public $startDate;
    ...
    public function view(): View
    {
        ...
        return view('pages.reports.events.coordinator_report_generate', ['events'=>$events]);
    }
